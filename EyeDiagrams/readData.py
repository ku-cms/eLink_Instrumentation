...
type1_height_34g = pd.read_excel(excel_file, sheet_name=excel_sheet, header=None, usecols=type1_cols_height_34, skiprows=type1_rows_height_34)
type1_height_34g = type1_height_34g.drop(range(11, 31))
#print(y_height_34g)

type1_cols_width_34 = [6, 7, 8]
type1_rows_width_34 = [0, 1, 2]
type1_width_34g = pd.read_excel(excel_file, sheet_name=excel_sheet, header=None, usecols=type1_cols_width_34, skiprows=type1_rows_width_34)
type1_width_34g = type1_width_34g.drop(range(11, 31))
#print(y_width_34g)

test_cols_height_34 = [3, 4, 5, 6]
test_rows_height_34 = range(0, 16)
test_height_34g = pd.read_excel(excel_file, sheet_name=excel_sheet, header=None, usecols=test_cols_height_34, skiprows=test_rows_height_34)
test_height_34g = test_height_34g.drop(range(6, 18))
#print(L_heights_34g)

test_cols_width_34 = [7, 8, 9, 10]
test_rows_width_34 = range(0, 16)
test_width_34g = pd.read_excel(excel_file, sheet_name=excel_sheet, header=None, usecols=test_cols_width_34, skiprows=test_rows_width_34)
...
type3_height_36g = pd.read_excel(excel_file, sheet_name=excel_sheet, header=None, usecols=type3_cols_height_36, skiprows=type3_rows_height_36)
type3_height_36g = type3_height_36g.drop(range(2, 5))
#print(y_heights_36g)

type3_cols_width_36 = [9, 10, 11, 12, 13, 14]
type3_rows_width_36 = range(0, 30)
type3_width_36g = pd.read_excel(excel_file, sheet_name=excel_sheet, header=None, usecols=type3_cols_width_36, skiprows=type3_rows_width_36)
type3_width_36g = type3_width_36g.drop(range(2, 5))
#print(y_width_36g)

type4_cols_height_36 = [3, 4, 5, 6, 7, 8]
type4_rows_height_36 = range(0, 35)
type4_height_36g = pd.read_excel(excel_file, sheet_name=excel_sheet, header=None, usecols=type4_cols_height_36, skiprows=type4_rows_height_36)

#print(L_height_36g)

type4_cols_width_36 = [9, 10, 11, 12, 13, 14]
type4_rows_width_36 = range(0, 35)
type4_width_36g = pd.read_excel(excel_file, sheet_name=excel_sheet, header=None, usecols=type4_cols_width_36, skiprows=type4_rows_width_36)
