#set a few filenames and paths
set firt_bit_file "C:/Users/Public/Documents/cable_tests/cable_test_705.bit"
#make sure we are pointed to the right directory
...
set_property PROGRAM.FILE $firt_bit_file $first_hw_device
program_hw_devices $first_hw_device

refresh_hw_device [lindex [get_hw_devices xc7k325t_0] 0]

set xil_newLinks [list]
set xil_newLink [create_hw_sio_link -description {Link 0} [lindex [get_hw_sio_txs localhost:3121/xilinx_tcf/Digilent/210203AE483DA/0_1_0/IBERT/Quad_117/MGT_X0Y8/TX] 0] [lindex [get_hw_sio_rxs localhost:3121/xilinx_tcf/Digilent/210203AE483DA/0_1_0/IBERT/Quad_117/MGT_X0Y8/RX] 0] ]
